...
var _eeue56$elm_xml$Xml_Decode$decodeBool = function (str) {
	return _elm_lang$core$Native_Utils.eq(str, 'true') ? _elm_lang$core$Result$Ok(
		_eeue56$elm_xml$Xml$BoolNode(true)) : (_elm_lang$core$Native_Utils.eq(str, 'false') ? _elm_lang$core$Result$Ok(
		_eeue56$elm_xml$Xml$BoolNode(false)) : _elm_lang$core$Result$Err('Not a bool'));
};
var _eeue56$elm_xml$Xml_Decode$decodeFloat = function (str) {
	var _p0 = _elm_lang$core$String$toFloat(str);
	if (_p0.ctor === 'Err') {
		return _elm_lang$core$Result$Err(_p0._0);
	} else {
		return _elm_lang$core$Result$Ok(
			_eeue56$elm_xml$Xml$FloatNode(_p0._0));
	}
};
var _eeue56$elm_xml$Xml_Decode$decodeInt = function (str) {
	var _p1 = _elm_lang$core$String$toInt(str);
	if (_p1.ctor === 'Err') {
		return _elm_lang$core$Result$Err(_p1._0);
	} else {
		return _elm_lang$core$Result$Ok(
			_eeue56$elm_xml$Xml$IntNode(_p1._0));
	}
};
var _eeue56$elm_xml$Xml_Decode$decodeString = function (str) {
	return _elm_lang$core$Result$Ok(
		_eeue56$elm_xml$Xml$StrNode(str));
};
var _eeue56$elm_xml$Xml_Decode$propRegex = _elm_lang$core$Regex$regex(' .+?=\".+?\"');
var _eeue56$elm_xml$Xml_Decode$decodeProps = function (str) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (decoder, val) {
				var _p2 = val;
				if (_p2.ctor === 'Ok') {
					return val;
				} else {
		...
		{
			ctor: '::',
			_0: _eeue56$elm_xml$Xml_Decode$decodeBool,
			_1: {
				ctor: '::',
				_0: _eeue56$elm_xml$Xml_Decode$decodeInt,
				_1: {
					ctor: '::',
					_0: _eeue56$elm_xml$Xml_Decode$decodeFloat,
					_1: {
						ctor: '::',
						_0: _eeue56$elm_xml$Xml_Decode$decodeString,
						_1: {ctor: '[]'}
					}
				}
			}
...
var _eeue56$elm_xml$Xml_Decode$parseProps = _elm_lang$core$List$filterMap(
	function (n) {
		var _p3 = A2(_elm_lang$core$String$split, '=', n);
		if (((_p3.ctor === '::') && (_p3._1.ctor === '::')) && (_p3._1._1.ctor === '[]')) {
			var withoutQuotes = A2(
				_elm_lang$core$String$dropRight,
				1,
				A2(_elm_lang$core$String$dropLeft, 1, _p3._1._0));
			var _p4 = _eeue56$elm_xml$Xml_Decode$decodeProps(withoutQuotes);
			if (_p4.ctor === 'Err') {
				return _elm_lang$core$Maybe$Nothing;
			} else {
				return _elm_lang$core$Maybe$Just(
...
var _eeue56$elm_xml$Xml_Decode$findProps = function (_p5) {
	return _elm_lang$core$Dict$fromList(
		_eeue56$elm_xml$Xml_Decode$parseProps(
			A2(
				_elm_lang$core$List$map,
				function (_p6) {
				...
				A3(
					...
					_eeue56$elm_xml$Xml_Decode$propRegex,
					function (s) {
...
var _eeue56$elm_xml$Xml_Decode$parseSlice = F3(
	function (first, firstClose, trimmed) {
		var beforeClose = A3(_elm_lang$core$String$slice, first + 1, firstClose, trimmed);
		var words = _elm_lang$core$String$words(beforeClose);
		var tagName = A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			_elm_lang$core$List$head(words));
		var closeTag = A2(
			_elm_lang$core$Basics_ops['++'],
			'</',
			A2(_elm_lang$core$Basics_ops['++'], tagName, '>'));
		var props = _eeue56$elm_xml$Xml_Decode$findProps(words);
		var _p7 = A2(_elm_lang$core$String$indexes, closeTag, trimmed);
		if (_p7.ctor === '[]') {
			if (A2(_elm_lang$core$String$startsWith, '?', tagName)) {
				return _elm_lang$core$Result$Ok(
					{
						ctor: '_Tuple2',
						_0: A2(_eeue56$elm_xml$Xml$DocType, tagName, props),
						_1: firstClose + 1
					});
			} else {
				if (A2(_elm_lang$core$String$endsWith, '/', beforeClose)) {
					var tag = A2(_elm_lang$core$String$endsWith, '/', tagName) ? A3(_elm_lang$core$String$slice, 0, -1, tagName) : tagName;
					return _elm_lang$core$Result$Ok(
						{
							ctor: '_Tuple2',
							_0: A3(
					...
					return _elm_lang$core$Result$Err(
						A2(_elm_lang$core$Basics_ops['++'], 'Failed to find close tag for ', tagName));
				}
			}
		} else {
			var _p9 = _p7._0;
			var contents = A3(_elm_lang$core$String$slice, firstClose + 1, _p9, trimmed);
			var _p8 = _eeue56$elm_xml$Xml_Decode$decodeChildren(contents);
			if (_p8.ctor === 'Err') {
				...
				return _elm_lang$core$Result$Ok(
					{
						ctor: '_Tuple2',
						_0: A3(_eeue56$elm_xml$Xml$Tag, tagName, props, _p8._0),
						_1: _p9 + _elm_lang$core$String$length(closeTag)
					});
			}
		}
	});
var _eeue56$elm_xml$Xml_Decode$decodeChildren = function (str) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (decoder, val) {
		...
		{
			ctor: '::',
			_0: _eeue56$elm_xml$Xml_Decode$decode,
			_1: {
				ctor: '::',
				_0: _eeue56$elm_xml$Xml_Decode$decodeInt,
				_1: {
...
var _eeue56$elm_xml$Xml_Decode$decode = function (text) {
	var _p11 = _elm_lang$core$String$trim(text);
	if (_p11 === '') {
		return _elm_lang$core$Result$Ok(
			_eeue56$elm_xml$Xml$Object(
				{ctor: '[]'}));
		...
		return A2(
			...
			_eeue56$elm_xml$Xml$Object,
			_eeue56$elm_xml$Xml_Decode$actualDecode(_p11));
	}
};
var _eeue56$elm_xml$Xml_Decode$actualDecode = function (text) {
	var closeIndexes = A2(_elm_lang$core$String$indexes, '>', text);
	var openIndexes = A2(_elm_lang$core$String$indexes, '<', text);
	var _p12 = {ctor: '_Tuple2', _0: openIndexes, _1: closeIndexes};
	if (((_p12.ctor === '_Tuple2') && (_p12._0.ctor === '::')) && (_p12._1.ctor === '::')) {
		return A2(
			...
			function (_p13) {
				var _p14 = _p13;
				var _p17 = _p14._0;
				var _p15 = _eeue56$elm_xml$Xml_Decode$actualDecode(
					A3(
				...
				if (_p15.ctor === 'Err') {
					var _p16 = _p15._0;
					return _elm_lang$core$Native_Utils.eq(_p16, 'Nothing left') ? _elm_lang$core$Result$Ok(
						{
							ctor: '::',
							_0: _p17,
							_1: {ctor: '[]'}
						...
						A2(
							...
							A2(
								...
								A2(_elm_lang$core$Basics_ops['++'], ', but then hit ', _p16))));
				} else {
					return _elm_lang$core$Result$Ok(
						A2(
							_elm_lang$core$Basics_ops['++'],
			...
			A3(_eeue56$elm_xml$Xml_Decode$parseSlice, _p12._0._0, _p12._1._0, text));
	} else {
		return _elm_lang$core$Result$Err('Nothing left');
	}
};
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'category',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Projects$Project))))))));
var _user$project$Projects$loadProjects = function (str) {
	var _p0 = A2(
		_elm_lang$core$Json_Decode$decodeString,
		_elm_lang$core$Json_Decode$list(_user$project$Projects$projectDecoder),
		str);
	if (_p0.ctor === 'Ok') {
		return _p0._0;
	} else {
...
var _user$project$Projects$data = {
	ctor: '::',
	_0: A7(
														...
														_1: {
															...
															_1: {
																...
																_0: A7(
																	...
																	_elm_lang$core$Maybe$Just('https://medium.com/happyprogrammer-in-jeju/다음-캘린더-서비스의-비하인드-스토리-ec0faac67f05'),
																	'TFT장',
																	{
																		ctor: '::',
																		_0: '팀리딩',
																							...
																							_1: {
																								...
																								_1: {
																									...
																									_0: A7(
																										...
																										_elm_lang$core$Maybe$Just('https://github.com/hatemogi/AewolInput'),
																										'개인',
																										{
																											ctor: '::',
																											_0: 'Objective-C',
...
var _user$project$Projects$tags = _elm_lang$core$Set$toList(
...
var _user$project$Main$loadMediumFeed = _elm_lang$core$Platform_Cmd$none;
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$markdown = function (content) {
	return A2(
	...
	},
	{
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src('img/profile.jpg'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('card-content has-text-left'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$Main$markdown('백엔드 개발자. **이상적 Clojure**와 **현실적 Java**를 오가며 **실용 프로그래밍**.\n            개발에 몰입할 때가 가장 즐거운 걸 보면 아무래도 **백발 개발자**가 될 모양새.'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('https://medium.com/happyprogrammer-in-jeju'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('fab fa-medium fa-lg'),
														_1: {ctor: '[]'}
													},
													{ctor: '[]'}),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text(' 미디엄 보기'),
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('hatemogi.com'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$profileView,
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Main$init('테스트'),
