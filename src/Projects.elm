module Projects exposing (Project, data, tags, ProjectCategory(..), categoryName)

import Set

type ProjectCategory = Work | Personal | Presentation | Translation

categoryName : ProjectCategory -> String
categoryName cat =
    case cat of
       Work -> "업무"
       Personal -> "개인"
