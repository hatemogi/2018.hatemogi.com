...
var $author$project$Main$Filtered = function (a) {
	return {$: 'Filtered', a: a};
};
var $author$project$Main$Model = F4(
	function (key, url, route, projectOption) {
		return {key: key, projectOption: projectOption, route: route, url: url};
	});
var $author$project$Projects$Work = {$: 'Work'};
var $author$project$Main$R404 = {$: 'R404'};
var $author$project$Main$R글 = {$: 'R글'};
var $author$project$Main$R소개 = {$: 'R소개'};
var $author$project$Main$R코틀린 = {$: 'R코틀린'};
var $author$project$Main$R프로젝트 = {$: 'R프로젝트'};
...
var $author$project$Main$urlToRoute = function (url) {
	...
	while (true) {
		if (!paths.b) {
			return $author$project$Main$R소개;
		} else {
			if (!paths.b.b) {
				switch (paths.a) {
					case 'index.html':
					...
					case '소개':
						return $author$project$Main$R소개;
					case '프로젝트':
						return $author$project$Main$R프로젝트;
					case '글':
						return $author$project$Main$R글;
					case '코틀린':
						return $author$project$Main$R코틀린;
					default:
						break _v0$6;
				}
			} else {
	...
	return $author$project$Main$R404;
};
	...
	function (flags, url, key) {
		return _Utils_Tuple2(
			A4(
				...
				$author$project$Main$Filtered($author$project$Projects$Work)),
			$elm$core$Platform$Cmd$none);
	});
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							route: $author$project$Main$urlToRoute(url),
							url: url
						}),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$KotlinStudy$codeIndent = function (code) {
	var lines = $elm$core$String$lines(code);
	var nonEmptyLines = A2(
		...
		lines);
	var leftSpace = function (s) {
		return $elm$core$String$length(s) - $elm$core$String$length(
	...
	var minLeft = A2(
		...
		$elm$core$List$minimum(
			A2($elm$core$List$map, leftSpace, nonEmptyLines)));
	return A2(
		$elm$core$String$join,
		'\n',
		A2(
			$elm$core$List$map,
			$elm$core$String$dropLeft(minLeft),
			lines));
};
				...
				_List_fromArray(
					[
						...
						$elm$json$Json$Encode$string(
							$author$project$KotlinStudy$codeIndent(code))),
						A2(
						$elm$html$Html$Attributes$property,
						'language',
						...
						A2($elm$html$Html$Attributes$attribute, 'id', 'kotlin-example')
					]),
				_List_Nil);
		default:
			var title = block.a;
...
var $author$project$KotlinStudy$sectionView = function (section) {
	return A2(
		...
		A2(
			...
			A2($elm$core$List$map, $author$project$KotlinStudy$blockView, section.content)));
};
var $author$project$KotlinStudy$articleView = function (article) {
	return A2(
		...
		A2(
			...
			A2($elm$core$List$map, $author$project$KotlinStudy$sectionView, article.sections)));
};
var $author$project$KotlinStudy$Article = F3(
	function (id, title, sections) {
		return {id: id, sections: sections, title: title};
	});
var $author$project$KotlinStudy$Kotlin = F2(
	function (a, b) {
		return {$: 'Kotlin', a: a, b: b};
	});
...
var $author$project$Main$kotlinStudyView = function (model) {
	return $author$project$KotlinStudy$articlesView(
		$author$project$KotlinStudy$Model(model.key));
};
...
var $author$project$Main$profileView = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Main$markdown('백엔드 개발자. 취미로 시작한 개발이 전공과 직업이 되었고,\n                여전히 개발에 몰입할 때가 가장 즐거운 걸 보면 아무래도 백발 개발자가 될 모양새.')
				])),
			A2(
			$elm$html$Html$footer,
			_List_fromArray(
...
var $author$project$Main$AllProjects = {$: 'AllProjects'};
var $author$project$Projects$Personal = {$: 'Personal'};
var $author$project$Projects$Presentation = {$: 'Presentation'};
var $author$project$Main$ProjectOption = function (a) {
	return {$: 'ProjectOption', a: a};
};
var $author$project$Projects$Translation = {$: 'Translation'};
var $author$project$Projects$categoryName = function (cat) {
	switch (cat.$) {
		case 'Work':
			return '업무';
		case 'Personal':
...
var $author$project$Projects$data = _List_fromArray(
	[
		...
		$author$project$Projects$Personal,
		2019,
		...
		A7(
		$author$project$Projects$Project,
		$author$project$Projects$Presentation,
		2017,
		'한글 코딩 도구 비지니스 피칭',
		...
		A7(
		$author$project$Projects$Project,
		$author$project$Projects$Translation,
		2015,
...
var $author$project$Main$projectsView = function (model) {
	...
	var filterColor = function (filter) {
		if (filter.$ === 'Filtered') {
			var category = filter.a;
								...
								[
									...
									_List_fromArray(
										[
											...
											filterColor(
												$author$project$Main$Filtered(p.category)))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(
											$author$project$Projects$categoryName(p.category))
										]))
								]))
						])),
					A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$class(
					function () {
						var _v1 = _Utils_eq(filter, model.projectOption);
						if (_v1) {
							return filterColor(filter);
						} else {
							return '';
						}
					}()),
					$elm$html$Html$Events$onClick(
					$author$project$Main$ProjectOption(filter))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
					function () {
						if (filter.$ === 'Filtered') {
							var category = filter.a;
							return $author$project$Projects$categoryName(category);
						} else {
							return '전체';
						}
					}())
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						button($author$project$Main$AllProjects),
						button(
						$author$project$Main$Filtered($author$project$Projects$Work)),
						button(
						$author$project$Main$Filtered($author$project$Projects$Personal)),
						button(
						$author$project$Main$Filtered($author$project$Projects$Presentation)),
						button(
						$author$project$Main$Filtered($author$project$Projects$Translation))
					])),
				A3(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(menu, $author$project$Main$R소개, 'fa-user-circle'),
						A2(menu, $author$project$Main$R프로젝트, 'fa-file-code'),
						A2(menu, $author$project$Main$R글, 'fa-edit')
					]))
			]));
};
var $author$project$Main$view = function (model) {
	return {
		...
		title: 'hatemogi.com - ' + $author$project$Main$routeToTitle(model.route)
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Main$init, onUrlChange: $author$project$Main$UrlChanged, onUrlRequest: $author$project$Main$LinkClicked, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"ProjectOption":["Main.ProjectFilter"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.ProjectFilter":{"args":[],"tags":{"Filtered":["Projects.ProjectCategory"],"AllProjects":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Projects.ProjectCategory":{"args":[],"tags":{"Work":[],"Personal":[],"Presentation":[],"Translation":[]}}}}})}});}(this));