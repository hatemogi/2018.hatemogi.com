...
var author$project$Main$Model = F4(
	function (key, url, section, projectFilter) {
		return {Y: key, M: projectFilter, F: section, aN: url};
	});
var author$project$Main$S소개 = 0;
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A4(author$project$Main$Model, key, url, 0, elm$core$Maybe$Nothing),
...
var author$project$Intro$Section = F3(
	function (title, url, description) {
		return {au: description, aL: title, aN: url};
	});
...
var author$project$Main$S프로젝트 = 1;
				...
				[
					...
					_List_fromArray(
						[
							...
							author$project$Main$markdown(section.au)
						]))
				]));
	};
	return A2(
...
var author$project$Projects$Project = F7(
	function (category, year, title, url, role, tags, description) {
		return {I: category, au: description, aG: role, aK: tags, aL: title, aN: url, ap: year};
	});
					...
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href(url),
								elm$html$Html$Events$onClick(
								author$project$Main$Go(section))
							]),
						_List_fromArray(
							[
								A2(
...
var author$project$Main$main = elm$browser$Browser$application(
	{aA: author$project$Main$init, aC: author$project$Main$UrlChanged, aD: author$project$Main$LinkClicked, aH: author$project$Main$subscriptions, aM: author$project$Main$update, aO: author$project$Main$view});
